...
export default function AboutUs() {
  return (
    <div className="text-center md:gap-8 gap-4 py-12 flex flex-col">
      <div className="md:gap-8 gap-4 py-12 flex flex-col px-12">
        ...
        <p className="text-justify">
          ...
          <strong>prevence a vzdělávání se v&nbsp;první pomoci</strong>.
          Přestože dokážu druhé nadchnout, uvědomila jsem si, že v mé snaze
          popularizovat první pomoc chybí něco zásadního.{" "}
          <strong>Jedno místo</strong>, kam mohu druhé odkázat, kde by každý{" "}
          <strong>snadno a rychle</strong> našel kurz či jiný typ vzdělávání v
          první pomoci <strong>podle svých potřeb</strong>. A tak se zrodila
          myšlenka na webový vyhledávač vzdělávání právě v první pomoci. A
          protože vím, že Mám jen jeden, neotálela jsem a od stavění hradů z
          písku jsem začala běhat k počítači. Teď se vyhledávač ještě peče, ale
          až bude na světě, bude místem, kde si každý přijde na to svoje.
        </p>
        <p>
          <strong>Místem, kde</strong>
        </p>
        <p className="text-justify self-center">
          ...
          <br />
          <strong>Pavel a Eliška</strong>, nastávající rodiče,{" "}
          <strong>najdou</strong> kurz, který jim dá jistotu v péči o miminko,
          <br />
          <strong>Jana</strong>, která se chystá o prázdninách pracovat v
          Itálii, <strong>najde</strong> kurz plavčíka,
          <br />
      ...
      <div className="md:gap-8 gap-4 py-12 flex flex-col px-12 bg-background-white">
        ...
        <div className="flex text-left gap-8 justify-between flex-wrap">
          ...
          <div className="w-full md:w-5/12">
            ...
            <p>
              Děláme to pro sebe, pro svou rodinu a blízké i pro ty, které
              potkáme na ulici. Spolu umíme první pomoc. Spolu zachraňujeme
              životy.
            </p>
          </div>
          <div className="w-full md:w-5/12">
